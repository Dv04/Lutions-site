  ...
  return (
    <div id="join-us" className="bg-white dark:bg-neutral-950/70 backdrop-blur-lg p-8 rounded-lg border border-neutral-200 dark:border-neutral-800 mt-12">
      ...
      <div className="mt-8 grid grid-cols-1 md:grid-cols-2 gap-6">
        <div className="flex flex-col items-center text-center p-6 bg-neutral-50 dark:bg-neutral-900 rounded-lg border border-neutral-200 dark:border-neutral-700">
